				...
				<Card>
					...
					<CardContent>
						<p className="text-sm text-muted-foreground mb-4">
							View timesheets organized by week with detailed breakdowns of
							hours per project and task.
						</p>
					...
					<CardHeader>
						<div className="flex items-center gap-3">
							...
							<div>
								...
								<CardDescription>View pending expense reports</CardDescription>
							</div>
						</div>
					</CardHeader>
					<CardContent>
						<p className="text-sm text-muted-foreground mb-4">
							View expense reports organized by week with receipts and detailed
							breakdowns.
						</p>
						<Button asChild className="w-full gap-2">
			...
			<Card className="border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950/30">
				<CardHeader>
					<CardTitle className="text-base">
						Important: Approvals Must Be Done in Harvest
					</CardTitle>
				</CardHeader>
				<CardContent className="text-sm space-y-2">
					<p>
						• This view allows you to review pending timesheets and expenses
						organized by week
					</p>
					<p>
						• Click "View" to see detailed breakdowns of time entries and
						expense reports
					</p>
					<p>
						•{" "}
						<strong>
							Actual approvals must be submitted via the Harvest web interface
						</strong>
					</p>
					<p>
						• Use the "Open Harvest" button on detail pages to approve
						timesheets in Harvest
					</p>
					<p className="pt-2">
