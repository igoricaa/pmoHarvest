  ...
  const filteredClients = useMemo(() => {
    ...
    if (searchQuery) {
      ...
      clients = clients.filter(
        c => c.name.toLowerCase().includes(query) || c.currency.toLowerCase().includes(query)
      );
    }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage clients and customer organizations</p>
        </div>
      ...
      {/* Modals */}
      <ClientFormModal open={isCreateModalOpen} onOpenChange={setIsCreateModalOpen} />
      <ClientFormModal
        open={!!editClientId}
