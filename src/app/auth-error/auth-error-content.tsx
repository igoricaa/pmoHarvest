...
> = {
	...
	server_error: {
		title: "Server Error",
		description:
			"Harvest OAuth server encountered an error. This is usually temporary.",
		action: "Please try again in a few moments.",
	},
	session_expired: {
		title: "Session Expired",
		description:
			"Your session has expired and your Harvest access token could not be refreshed.",
	...
	no_harvest_account: {
		...
		description:
			"You do not appear to have a Harvest account in the PMO Hive organization.",
		action:
			"Please contact your administrator to be added to the Harvest account.",
	},
	unauthorized: {
		title: "Unauthorized",
