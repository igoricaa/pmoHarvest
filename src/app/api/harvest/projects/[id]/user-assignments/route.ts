...
import type { CreateUserAssignmentInput } from '@/types/harvest';
...
export async function GET(
  ...
  try {
    ...
    const assignments = await client.getProjectUserAssignments(projectId, queryParams);
...
export async function POST(
  ...
  try {
    ...
    const client = createHarvestClient(accessToken);
    const assignment = await client.createUserAssignment(projectId, validation.data);
